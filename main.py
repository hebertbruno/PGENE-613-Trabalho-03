...
from plot import plot_training_curves, plot_confusion_matrix
...
save_predictions_to_csv(model, X_val, y_val, activity_mapping, 'results/validation_predictions.csv')